...
Could not get the updateUser.php script to change the password or username in testing, might be an environment error on my part. I did however get it to update both the first and lastnames of the user.